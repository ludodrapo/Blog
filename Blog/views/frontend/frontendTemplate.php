...
{
?>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="index.php?action=login"><i class="fas fa-sign-in-alt"></i> Connexion</a></li>
            ...
            <div class="container">
                ...
                <div class="row mb-5">
                    <div class="col-lg-8 mx-lg-auto mx-5 bg-white shadow rounded">
                        ...
                        <form method="post" action="index.php" id="contactForm" name="sendMail" class="p-3">
<?php
if (!isset($_SESSION['login_name']))
{
?>
