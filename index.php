<?php
/**
 * Index for the frontend redirections. Author : Ludo Drapo.
 */
...
try {
    if (isset($_GET['action']) && !empty($_GET['action'])) {
        if ($_GET['action'] === 'displayAllPosts') {
            ...
            include 'views/frontend/frontendUpdateEmail.php';
        } elseif ($_GET['action'] === 'goToUpdatePassword') {
            include 'views/frontend/frontendUpdatePassword.php';
        } elseif ($_GET['action'] === 'goToAdmin') {
            include 'views/frontend/frontendGoToAdmin.php';
        } elseif ($_GET['action'] === 'goToResume') {
            include 'views/frontend/resume.php';
            ...
            if (isset($_POST['new_password_1']) && !empty($_POST['new_password_1'])
                && isset($_POST['new_password_2']) && !empty($_POST['new_password_2'])
    ...
    include 'views/frontend/frontendBugMessage.php';
}
