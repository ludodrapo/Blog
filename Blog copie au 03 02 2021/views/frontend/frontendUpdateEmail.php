...
<section class="page-section">
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-lg-8 mx-lg-auto mx-3 bg-light pt-4 pb-5 shadow rounded">
                ...
                <div class="text-center">
                	<a href="index.php?action=profile"><button class="btn btn-danger btn-l">Non, finalement, non.</button></a>
                </div>
            </div>
        </div>
    </div>
