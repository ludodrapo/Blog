...
<section class="page-section bg-light">
	<div class="container">
        <div class="row justify-content-center pt-lg-5 pt-3">
            <div class="col-lg-8 pt-4 mb-3 mx-3 shadow rounded">
...
{
?>
 			<div class="col-lg-8 m-3 bg-white rounded shadow">
                <form method="post" action="index.php?action=addComment&amp;post_id=<?=$post_details['post_id']?>">
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls mb-0 pb-2">
                            <label>Commentaire</label>
                            <textarea class="form-control" name="comment" rows="5" placeholder="Ton commentaire ici ..." required ></textarea>
                        </div>
                    </div>
                    <br />
...
?>
			<div class="col-lg-8">
				<p class="mb-3">
					<em>Si tu souhaites toi aussi ajouter un commentaire, tu dois être inscrit(e) et connecté(e). En plus, c'est super simple, il suffit de <a href="index.php?action=login">cliquer ici</a> !</em>
				</p>
			</div>
<?php
}
