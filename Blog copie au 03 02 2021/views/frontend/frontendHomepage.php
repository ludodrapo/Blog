...
?>
            ...
            <div class="col-md-6 col-lg-4 bg-light mb-5">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 ml-auto">
            	<p class="lead">
            		Ex-retail manager et futur développeur web, passionné d'images, de mots et de notes. Je suis rigoureux, autonome, créatif, réactif, pédagogue et doté d'un excellent relationnel.
            	</p>
            </div>
            <div class="col-lg-5 mr-auto">
            	<p class="lead">
            		Avec Ludo dans votre équipe, vous êtes certain d'avoir quelqu'un sur qui vous pourrez compter, facile à manager et dont l'enthousiasme communicatif illustre l'adage : "On peut être pro sans se prendre au sérieux". 
            	</p>
            </div>
        </div>
