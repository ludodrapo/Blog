...
try {
    if (isset($_GET['action']) && !empty($_GET['action'])) {
        if ($_GET['action'] === 'displayAllPosts') {
            ...
            include 'views/backend/backendNewPost.php';
            ...
            if (!isset($_GET['user_id']) || empty($_GET['user_id'])) {
                throw new Exception("Nous n'avons pas reconnu l'identifiant de l'utilisateur à réactiver.", 1);
            }
    ...
    include 'views/backend/backendBugMessage.php';
}
