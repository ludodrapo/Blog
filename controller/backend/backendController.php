...
function displayAllSubscribers(): void
{
    ...
    include 'views/backend/backendListAllSubscribers.php';
}
...
function displayAllPosts(): void
{
    ...
    include 'views/backend/backendListAllPosts.php';
}
...
function fillUpdatePostPage($post_id): void
{
    ...
    include 'views/backend/backendUpdatePost.php';
}
...
function displayAwaitingComments(): void
{
    ...
    include 'views/backend/backendValidateComments.php';
}
...
function deleteComment($comment_id): void
{
    ...
    $headers = "From: noreply@leblodeludo.com\n"; // This is the email address the generated message will be from. We recommend using something like noreply@yourdomain.com.
...
function fillBackendHomepage(): void
{
    ...
    include 'views/backend/backendHomepage.php';
}
...
function uploadImage(): void
{
    ...
    if ($_FILES['image_to_upload']['size'] > 500000) {
        throw new Exception('La taille du fichier dépasse les 500 Ko et ne peut donc être transféré.', 1);
    }
    ...
    if (move_uploaded_file($_FILES['image_to_upload']['tmp_name'], $target_file)) {
        ...
        include 'views/backend/backendCongrats.php';
    } else {
